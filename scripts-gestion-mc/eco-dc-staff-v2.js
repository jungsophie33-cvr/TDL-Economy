 ...
 * CE QU'IL NE FAIT PAS : vérification des conditions membres (eco-dc-membre.js),
 * gestion des groupes et suppression d'un membre (eco-dc-gestion.js).
 *
 * CARTE DES BLOCS :
...
(function (DC, CFG, T) {
  ...
  // Relit la base au chargement et réaffiche un formulaire d'ajout pour chaque
  ...
  DC.initStaff = function (ancrage) {
    ...
    // Une seule lecture partagée : évite 3 appels Firebase simultanés.
