...
window.DC.TEXTES = {
  ...
  LABEL_AVATAR:         "Faceclaim à réserver (facultatif)",
  PH_RESUME:            "Décrivez votre idée de personnage, son background, ses motivations…",
  PH_AVATAR:            "Nom de l'acteur souhaité — laisser vide si vous n'avez pas encore choisi",
  ...
  STAFF_SANS_FC:        "Aucun faceclaim demandé",
