...
(function (FI, CFG, T) {
...
})(window.FI, window.FI.CFG, window.FI.TEXTES);        <input id="fi-lien-prelien" class="fi-input" type="url" placeholder="https://…">
      </div>
  ...
  async function chargerListesMembres(overlay) {
    const [membres, racinesDC] = await Promise.all([
      FI.chargerMembres(),
      FI.chargerRacinesDCEnAttente(),
    ]);
