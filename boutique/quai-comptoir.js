...
(function () {
  ...
  var DEFAUT = {
    pres:{cat:"presages",n:"Présage",ic:"ti-eye",p:80,desc:"Rêve, signe, intuition : une interprétation, jamais une réponse absolue.",na:"Expérience narrative",fo:"MP ou post MJ dans le sujet",us:"Unique",li:"N'offre qu'une interprétation, pas une réponse absolue.",rp:true},
    mp:{cat:"presages",n:"Mauvais pressentiment",ic:"ti-alert-triangle",p:150,desc:"Éviter un danger imminent dans un RP.",na:"Protection narrative",fo:"Post MJ",us:"Unique ⟡ en évent, intrigue et enquête seulement",li:"N'évite ni les catastrophes ni les conséquences de vos actions irréfléchies.",rp:true},
    grigri:{cat:"presages",n:"Gri-gri",ic:"ti-diamond",p:120,desc:"Amulette vaudou — ou plus folklorique selon sa source — qui vous accorde un hasard favorable.",na:"Relance d'un dé ou annulation d'un petit échec",fo:"Amulette dans l'inventaire",us:"Unique ⟡ à annoncer dans le post + tag admin",co:"Non rétroactif : si le dé est déjà lancé sans gri-gri, pas d'annulation.",rp:false},
    lecture:{cat:"presages",n:"Lecture des signes",ic:"ti-sparkles",p:200,desc:"Vision partielle offerte par les esprits du Bayou sur un objet, une personne ou une situation.",na:"Vision symbolique ⟡ indice",fo:"MP",us:"Unique ⟡ en enquête et intrigue seulement",li:"Vision cryptique : votre interprétation ne sera pas une vérité.",rp:true},
    aide:{cat:"presages",n:"Aide inattendue",ic:"ti-medal",p:180,desc:"Les saints sont de votre côté : une situation se désamorce, un objet est retrouvé, un inconnu providentiel intervient.",na:"Coïncidence heureuse",fo:"Médaille de St François dans l'inventaire",us:"Unique ⟡ à annoncer dans le post + tag admin",li:"Non rétroactif. Ne résout pas un conflit, ne sauve pas des vies.",rp:false},
    effigie:{cat:"presages",n:"Effigie rituelle",ic:"ti-ghost-2",gd:true,p:200,desc:"Le mauvais sort est invoqué contre un autre PJ.",na:"Mauvais sort sur un autre PJ",fo:"Poupée vaudou dans l'inventaire",us:"Unique ⟡ sur tirage de dé + tag admin + tag du PJ visé",li:"Ouvre une dette karmique : un retour de bâton pourrait arriver. Notée par le staff.",roll:[["1","Complication sérieuse"],["2 – 3","Complication légère"],["4","Rien"]],pick:{l:"Choix de la boutique",o:["Ti bon Ange","La Croisée","Lost Bayou"]},targetPJ:true,rp:false},
    protection:{cat:"presages",n:"Protection des ancêtres",ic:"ti-shield-heart",p:150,desc:"Vos ancêtres vous ont à la bonne et vous accordent leur protection.",na:"Protection contre une effigie ou un événement défavorable",fo:"Dollar porte-bonheur dans l'inventaire",us:"Actif dès l'achat ⟡ protège une fois, sur demande + tag admin",li:"Non rétroactif. Ne protège pas des catastrophes ni de vos actions irréfléchies.",rp:false},
    benediction:{cat:"presages",n:"Bénédiction des ancêtres",ic:"ti-shield-heart",p:500,desc:"La version supérieure : trois protections accordées par vos ancêtres.",na:"Protection contre tout événement négatif ou mauvais sort",fo:"Objet dans l'inventaire (à déterminer)",us:"Actif dès l'achat ⟡ 3 protections sur demande + tag admin",li:"Non rétroactif. Ne protège pas des catastrophes ni de la colère des bandes hors-la-loi.",rp:false},
    purif:{cat:"presages",n:"Purification du foyer",ic:"ti-home",p:200,desc:"Les Loas ou le Seigneur ont béni votre maison.",na:"Protection de lieu (habitation ou commerce)",fo:"Objet dans l'inventaire",us:"S'active par lancer de dé lors d'un aléa climatique",li:"Aucune protection contre les actions humaines.",roll:[["1","Protection totale"],["2 – 3","Protection partielle"],["4","Protection symbolique"]],rp:false},
    memoire:{cat:"presages",n:"Mémoire du bayou",ic:"ti-book",p:250,desc:"Un Ancien raconte une vieille histoire oubliée : un lieu, un secret de famille, un événement historique.",na:"Fragment d'un secret du lore",fo:"MP",us:"Unique",li:"Vous ne choisissez pas la nature du secret.",rp:"ctx"},

    ami:{cat:"rendre",n:"Un ami qui…",ic:"ti-user-plus",gd:true,p:100,desc:"Un contact arrive à point nommé : une information légère, une piste, un petit coup de main.",na:"PNJ one-shot",fo:"Post MJ",sv:"Petite info, piste, service",li:"Usage unique. Votre contact ne se mouillera pas pour vous sauver.",rp:true,dette:"faveur",as:FAV},
    ancien:{cat:"rendre",n:"Ancien service rendu",ic:"ti-history",gd:true,p:200,desc:"Un retour d'ascenseur pour un service premium.",na:"PNJ de votre passé",fo:"Post MJ — à vous de proposer le PNJ",sv:"Prêt de matériel, cachette, accès fermé, info fiable",li:"Usage unique. Rien de criminel.",rp:true,dette:"faveur",as:FAV},
    rdv:{cat:"rendre",n:"RDV difficile à obtenir",ic:"ti-calendar",gd:true,p:300,desc:"Un graissage de patte pour rencontrer un notable, un élu, un responsable d'ordinaire inaccessible.",na:"Accès exceptionnel à un personnage important de Terrebonne",fo:"RP avec MJ ou PJ",sv:"Rendez-vous important (négociation, service particulier…)",li:"Accord du joueur nécessaire pour un RDV avec un PJ.",pick:{l:"Cible du rendez-vous",o:["— PNJ (staff) —","— Choisir un PJ dans la liste —"]},rp:"ctx",dette:"faveur",as:FAV},
    info:{cat:"rendre",n:"L'info qui circule",ic:"ti-message-circle",gd:true,p:150,desc:"Les rumeurs ont parfois un fond de vérité et débloquent des situations.",na:"Rumeur crédible révélée",fo:"MP",us:"Unique par enquête ou évent",li:"Info vraie mais incomplète.",rp:true,dette:"faveur",as:FAV},
    jetais:{cat:"rendre",n:"J'étais là",ic:"ti-eye-check",p:60,desc:"Formalise un détail dont vous avez été témoin dans un RP terminé.",na:"Confirmation de témoin ⟡ inscription au lore",fo:"MP",us:"Formalise un souvenir important",co:"Évent ou intrigue terminé",rp:true},
    mainprot:{cat:"rendre",n:"Main : protection ponctuelle",ic:"ti-shield",gd:true,p:350,desc:"La Main fait comprendre à ceux qui vous nuisent qu'il vaut mieux laisser tomber : pression sociale ou intervention indirecte.",na:"Pression sociale ⟡ intimidation",fo:"Post MJ possible",us:"Utilisable 1 fois",li:"Pas de violence physique.",badge:"Porte entrouverte",targetPJ:true,rp:"ctx",dette:"main",as:MAINAS},
    maindisc:{cat:"rendre",n:"Main : discrétion assurée",ic:"ti-eye-off",gd:true,p:350,desc:"La Main étouffe un incident : un témoin se tait, un dossier s'égare, une rumeur naissante se détourne.",na:"Incident étouffé dans l'œuf",fo:"Post MJ",us:"Utilisable 1 fois",li:"N'efface pas une enquête vous concernant ni vos problèmes avec d'autres bandes.",badge:"Porte entrouverte",targetPJ:true,rp:"ctx",dette:"main",as:MAINAS},
    mainint:{cat:"rendre",n:"Main : intervention rapide",ic:"ti-bolt",gd:true,p:350,desc:"La Main sait agir vite quand la situation est urgente mais sans gravité (non criminelle).",na:"Action urgente",fo:"Post MJ",us:"Utilisable 1 fois",li:"Gravité minime : un délit possible, jamais un crime.",badge:"Porte entrouverte",rp:"ctx",dette:"main",as:MAINAS},

    sponl:{cat:"mondaine",n:"Sponsoring local",ic:"ti-heart-handshake",p:400,desc:"Participer financièrement à une initiative locale visible.",na:"Renforcement de réputation",fo:"Article dans le journal / post MJ",ja:"Climat social",po:"Communauté",rp:"ctx"},
    initiative:{cat:"mondaine",n:"Initiative régionale",ic:"ti-confetti",p:800,desc:"Participer financièrement à une initiative de la paroisse : foire, festival, grand projet de Terrebonne. Ouvre un évent membre important.",na:"Renforcement de réputation",fo:"Évent membre",ja:"Climat social (selon l'issue de l'évent)",po:"Paroisse",note:"Si l'évent est réussi, fait gagner un niveau de réputation.",rp:"ctx",ctxLabel:"Contexte de l'événement"},
    orga:{cat:"mondaine",n:"Organisateur",ic:"ti-masks-theater",p:300,desc:"Créateur d'un évent membre léger et social.",na:"Renforcement de réputation",fo:"Évent membre",ef:"PNJ ou événements inattendus injectés par le staff",li:"Initiative à petite échelle, pas d'impact sur les jauges.",rp:"ctx",ctxLabel:"Contexte de l'événement"},
    projecteur:{cat:"mondaine",n:"Coup de projecteur",ic:"ti-news",p:150,desc:"Une initiative, une réussite ou un engagement mérite d'être relayé au-delà de votre cercle habituel. Une telle mise en lumière peut ouvrir de nouvelles rencontres, créer des opportunités… ou des oppositions.",na:"Mise en lumière publique",fo:"Article de presse rédigé par l'acheteur",us:"Unique",li:"L'article doit rester cohérent avec les faits joués en RP. Le staff peut demander des ajustements avant publication. La démarche ne garantit ni adhésion ni succès.",as:"Rédigez un article de presse racontant l'événement. Après validation du staff, il sera publié dans le Journal et deviendra une information officielle de la vie locale.",rp:"ctxlink",article:true,linkLabel:"Lien (RP, événement créé, publication Insta)"},
    attention:{cat:"mondaine",n:"Attirer l'attention",ic:"ti-flare",p:800,desc:"Aide individuelle / contrer un projet communautaire de votre choix (d'une communauté différente de la vôtre).",na:"Position publique forte",fo:"Article journal",ja:"Activité clandestine",po:"Paroisse",ef:"Peut contribuer aux objectifs d'étape d'un grand projet, ou lui mettre des bâtons dans les roues. Attention aux problèmes qui en découleront…",pick:{l:"Projet communautaire visé",o:["— Sélectionner un projet —"]},rp:"ctxlink",linkLabel:"Lien d'un RP terminé (obligatoire)"}
  };

  var CATS = [
    { k:"presages", l:"Présages & aides aux dés", ic:"ti-eye" },
    { k:"rendre",   l:"Services à rendre",        ic:"ti-hand-stop" },
    { k:"mondaine", l:"Vie mondaine",             ic:"ti-glass-full" }
  ];

  /* ordre + icônes des « Informations clés » */
  var INFOS = [
    ["na","Nature","ti-shield"],["fo","Forme","ti-mail"],["us","Usage","ti-refresh"],
    ["ef","Effet","ti-flare"],["sv","Service","ti-package"],["co","Condition","ti-clipboard-check"],
    ["li","Limite","ti-flag"],["po","Portée","ti-target"],["ja","Impact jauge","ti-activity"],
    ["badge","Badge requis","ti-award"]
  ];
  ...
  function detail(id, api){
    ...
    var html = '<span class="qb-lab qb-dhl">Détails du service</span>'
      + '<div class="qb-dhead"><span class="qb-dic"><i class="ti '+esc(a.ic)+'"></i></span>'
    ...
    var kv = "";
    INFOS.forEach(function(f){ if (a[f[0]]) kv += '<div class="qb-kf"><i class="ti '+f[2]+'"></i><div><div class="qb-kl">'+esc(f[1])+'</div><div class="qb-kv">'+esc(a[f[0]])+'</div></div></div>'; });
    ...
    if (a.dette==="main") {
      html += ui.optcard({ ic:"ti-currency-dollar", titre:"Payer comptant", desc:"Réglez le montant total en dollars.", prix:money(a.p), btn:"Payer maintenant", act:"comptant", montant:a.p, pay:true, note:"Débloque le badge « Service demandé »." })
            + ui.optcard({ ic:"ti-scale", titre:"Service contre une dette", desc:"En échange d'une dette d'honneur lourde envers la Main.", prix:"0 $ + dette", btn:"Contracter", act:"dette", dette:"lourde", montant:0, note:"Débloque le badge « Rien n'est gratuit »." });
    } else if (a.dette==="faveur") {
      html += ui.optcard({ ic:"ti-currency-dollar", titre:"Payer comptant", desc:"Réglez le montant total en dollars.", prix:money(a.p), btn:"Payer maintenant", act:"comptant", montant:a.p, pay:true })
            + ui.optcard({ ic:"ti-scale", titre:"Petite faveur", desc:"À moindre coût, contre une dette narrative légère.", prix:"60 $ + dette", btn:"Contracter", act:"dette", dette:"legere", montant:60, note:"Dette notée par le staff, rappelée au moment opportun." });
    } else {
      html += ui.optcard({ ic:"ti-currency-dollar", titre:"Payer comptant", desc:"Réglez le montant total en dollars.", prix:money(a.p), btn:"Payer maintenant", act:"comptant", montant:a.p, pay:true });
    }
    html += '</div>';
  ...
  /* ===================== FORMULAIRE STAFF ===================== */
  var CHAMPS = [
    ["n","Nom"],["ic","Icône (Tabler)"],["p","Prix ($)"],["na","Nature"],["fo","Forme"],
  ...
  /* ===================== ENREGISTREMENT ===================== */
  Q.register({
    key:"comptoir", label:"Le Comptoir", sub:"personnel", icon:"ti-building-store",
