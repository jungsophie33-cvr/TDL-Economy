...
(function () {
  ...
  var DEFAUT = {
    ...
    effigie:{cat:"presages",n:"Effigie rituelle",ic:"dagger",gd:true,p:200,desc:"Le mauvais sort est invoqué contre un autre PJ.",na:"Mauvais sort sur un autre PJ",fo:"Poupée vaudou dans l'inventaire",us:"Unique ⟡ sur tirage de dé + tag admin + tag du PJ visé",li:"Ouvre une dette karmique : un retour de bâton pourrait arriver. Notée par le staff.",roll:[["1","Complication sérieuse"],["2 – 3","Complication légère"],["4","Rien"]],pick:{l:"Choix de la boutique",o:["Ti bon Ange","La Croisée","Lost Bayou"]},targetPJ:true,rp:false},
